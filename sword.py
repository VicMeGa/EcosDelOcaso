...
class Sword(pygame.sprite.Sprite):
    def __init__(self, player):
        ...
        original_loaded_image = pygame.image.load(
            get_asset_path("source/player/sword/1.png")).convert_alpha()
    ...
    def update(self, tiles):
        ...
        if self.player.direction == "right":
            ...
            self.rect.topleft = (
                self.player.rect.x + self.offset_x, self.player.rect.y + self.offset_y)
            ...
            self.rect.topright = (self.player.rect.x + 12,
